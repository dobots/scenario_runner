...
#include "proximity_condition.hpp"
...
int main(int argc, char * argv[])
{
  ...
  // We use the BehaviorTreeFactory to register our custom nodes
    ...
    factory.registerNodeType<CheckProximity>("CheckProximity");   
    ...
    auto tree = factory.createTreeFromFile("/home/reka/foxy2_ws/src/scenarios/xml/spawn_prox.xml");
